...
-- Date        : Wed Nov  8 16:18:58 2023
-- Host        : correlator4.fnal.gov running 64-bit Scientific Linux release 7.9 (Nitrogen)
-- Command     : write_vhdl -force -mode funcsim
--               /home/awhitbe1/LDMX_fw/zCCM_kria/zCCM_kria.gen/sources_1/bd/zccm_kria_block/ip/zccm_kria_block_clk_wiz_0_0/zccm_kria_block_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : zccm_kria_block_clk_wiz_0_0
...
entity zccm_kria_block_clk_wiz_0_0_clk_wiz is
  port (
...
end zccm_kria_block_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of zccm_kria_block_clk_wiz_0_0_clk_wiz is
  signal clk_in1_zccm_kria_block_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_zccm_kria_block_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      ...
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_zccm_kria_block_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_zccm_kria_block_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_zccm_kria_block_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_zccm_kria_block_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zccm_kria_block_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    resetn : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of zccm_kria_block_clk_wiz_0_0 : entity is true;
end zccm_kria_block_clk_wiz_0_0;

architecture STRUCTURE of zccm_kria_block_clk_wiz_0_0 is
begin
inst: entity work.zccm_kria_block_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
